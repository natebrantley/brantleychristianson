...
alter table public.users add column if not exists assigned_broker_slug text;
...
comment on column public.users.assigned_broker_slug is 'Broker slug from agents.json; set by client from /brokers.';
