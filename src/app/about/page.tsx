...
export default function AboutPage() {
  return (
    <main>
      <Hero
        title="A local, independent brokerage."
        lead="We serve Oregon and Washington with experienced brokers who know these markets—no franchise, no corporate playbook."
        variant="short"
