...
type OwnerUser = { first_name?: string | null; last_name?: string | null; email?: string | null; role?: string | null };
type LeadRow = {
  id: string;
        ...
        <div className="container stack--lg">
          ...
          <section className="dashboard-section" aria-labelledby="leads-db-heading">
            <header className="dashboard-section-header stack--xs">
              ...
              <h2 id="leads-db-heading" className="section-title">All leads</h2>
              <p className="section-lead">
                You have full access to all leads. Search, sort, and manage any lead; view and reassign assigned brokers.
              </p>
            </header>
